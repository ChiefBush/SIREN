                ...
                try {
                    ...
                    if (error) {
                        ...
                        setSensorData({
                            ...
                            temperature: parseFloat(latest.htu21d_temp) || 0.0,
                            humidity: parseFloat(latest.htu21d_humidity) || 0.0,
                ...
                try {
                    ...
                    if (error) {
                        ...
                        setSensorHistory(data.map(item => ({
                            ...
                            temperature: parseFloat(item.htu21d_temp) || 0,
                            humidity: parseFloat(item.htu21d_humidity) || 0,
